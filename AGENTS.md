...
- **Providers.** Codex, Claude, Cursor, Grok, OpenCode, Antigravity, and Kimi Code each have an adapter. Provider-shaped features need a decision per adapter, even if the decision is "not supported here".
